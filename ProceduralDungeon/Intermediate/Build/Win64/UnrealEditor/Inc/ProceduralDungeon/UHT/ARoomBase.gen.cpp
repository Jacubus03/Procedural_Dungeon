...
void EmptyLinkFunctionForGeneratedCodeARoomBase() {}
...
// ********** Begin Class ARoomBase ****************************************************************
void ARoomBase::StaticRegisterNativesARoomBase()
{
}
FClassRegistrationInfo Z_Registration_Info_UClass_ARoomBase;
UClass* ARoomBase::GetPrivateStaticClass()
{
	using TClass = ARoomBase;
	if (!Z_Registration_Info_UClass_ARoomBase.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("RoomBase"),
			Z_Registration_Info_UClass_ARoomBase.InnerSingleton,
			StaticRegisterNativesARoomBase,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_ARoomBase.InnerSingleton;
}
UClass* Z_Construct_UClass_ARoomBase_NoRegister()
{
	return ARoomBase::GetPrivateStaticClass();
}
struct Z_Construct_UClass_ARoomBase_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
		{ "IncludePath", "ARoomBase.h" },
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ARoomBase_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FClassParams Z_Construct_UClass_ARoomBase_Statics::ClassParams = {
	...
	0,
	UE_ARRAY_COUNT(Z_Construct_UClass_ARoomBase_Statics::PropPointers),
	0,
	0x009001A4u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ARoomBase_Statics::Class_MetaDataParams), Z_Construct_UClass_ARoomBase_Statics::Class_MetaDataParams)
};
UClass* Z_Construct_UClass_ARoomBase()
{
	if (!Z_Registration_Info_UClass_ARoomBase.OuterSingleton)
	{
		UECodeGen_Private::ConstructUClass(Z_Registration_Info_UClass_ARoomBase.OuterSingleton, Z_Construct_UClass_ARoomBase_Statics::ClassParams);
	}
	return Z_Registration_Info_UClass_ARoomBase.OuterSingleton;
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_Dell_Documents_Unreal_Projects_Procedural_Dungeon_ProceduralDungeon_Source_ProceduralDungeon_ARoomBase_h__Script_ProceduralDungeon_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Dell_Documents_Unreal_Projects_Procedural_Dungeon_ProceduralDungeon_Source_ProceduralDungeon_ARoomBase_h__Script_ProceduralDungeon_3293969853(TEXT("/Script/ProceduralDungeon"),
	Z_CompiledInDeferFile_FID_Users_Dell_Documents_Unreal_Projects_Procedural_Dungeon_ProceduralDungeon_Source_ProceduralDungeon_ARoomBase_h__Script_ProceduralDungeon_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Dell_Documents_Unreal_Projects_Procedural_Dungeon_ProceduralDungeon_Source_ProceduralDungeon_ARoomBase_h__Script_ProceduralDungeon_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
